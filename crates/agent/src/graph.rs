    ...
    graph.add_node("planner", |mut state: AskState, _config: &Config| async move {
        ...
        let system_prompt = format!(
            "You are Antigravity, a natural-language orchestration agent for DiskTracker.\n\
             ...
             - facts (volume TEXT, path TEXT, size INTEGER, modified_at INTEGER, is_directory BOOLEAN) -- current live file system metadata\n\
             - volume_snapshots / parent_snapshots -- historical snapshots\n\
             \n\
             DYNAMIC CONTEXT:\n\
             - Shell Mode: {}\n\
             - Operating System: {}\n\
